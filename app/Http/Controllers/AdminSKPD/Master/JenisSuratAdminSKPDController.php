...
class JenisSuratAdminSKPDController extends Controller
{
    public function index()
    {
        return view('admin_skpd.master.jenissurat.jenissurat_index', [
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('adminskpd.jenissurat.index');
    }
}
