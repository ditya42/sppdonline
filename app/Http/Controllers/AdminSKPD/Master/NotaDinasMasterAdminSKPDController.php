...
class NotaDinasMasterAdminSKPDController extends Controller
{
    public function index()
    {
        $jenissurat = JenisSurat::all();
        return view('admin_skpd.master.notadinas.notadinasmaster_index', [
    ...
    public function data()
    {
        ...
        ->leftJoin('tb_pegawai','sppd_notadinas.pembuat','=','tb_pegawai.pegawai_id')
        // ->orderBy('tb_skpd.skpd_nama','asc')
        ->orderBy('sppd_notadinas.created_at','desc')
        ->where('sppd_notadinas.skpd', $user->skpd_id)
        ->where('sppd_notadinas.nomor','<>',null)
        ->where('sppd_notadinas.tahun',$date)
            ...
            ->addColumn('action', function($data) {
                ...
                ';
                    ...
                    <div style="color: #fff">
                        ...
                        <a href="' .route('pegawaiberangkatadminskpdmaster.index',$data->id). '" class="btn btn-primary btn-sm"><i class="fa fa-odnoklassniki"> PNS Berangkat</i></a>
                        <a href="' .route('dasarnotaadminskpdmaster',$data->id). '" class="btn btn-primary btn-sm"><i class="fa fa-book"> Dasar Surat</i></a>
