        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <ul class="breadcrumb justify-content-end">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('superadminsuratkeluar.suratkeluar.index') }}">Data Surat Keluar </a></li>
            ...
            <div class="row clearfix">
                <div class="col-12">
                        <div class="card">
                            <br>
                            <a style="margin-left: 10px;" href="{{ route('superadminsuratkeluar.suratkeluar.index') }}"><button type="button" class="btn btn-success"><i class="fa fa-backward"></i> Kembali ke Surat Keluar</button></a>
      ...
      return function ( d, type, row ) {
        ...
        $(function() {
          table = $('.table').DataTable({
              processing: true,
              serverSide: true,
              ajax: '{!! route('superadminsuratkeluar.datatrash') !!}',
              columns: [
