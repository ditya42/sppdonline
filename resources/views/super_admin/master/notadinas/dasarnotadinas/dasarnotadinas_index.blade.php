                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <ul class="breadcrumb justify-content-end">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('superadmin.notadinas.index') }}">Nota Dinas Perjalanan</a></li>
            ...
            <div class="row clearfix">
                <div class="col-12">
                        <div class="card">
                            ...
                            <a style="margin-left: 10px;" href="{{ route('superadmin.notadinas.index') }}"><button type="button" class="btn btn-success"><i class="fa fa-backward"></i> Kembali</button></a>
    ...
    <script>
        ...
        $(function() {
          ...
          table = $('.table').DataTable({
              ...
              serverSide: true,
              "ajax": {
                    "url": "{!! route('superadmindasarnotadinas.data') !!}",
                    "data": {
                    "id": idnota
                    },
              },
        ...
        $(function() {
          $('#modaldasarnotapilih form').validator().on('submit', function(e) {
              if(!e.isDefaultPrevented()) {
                  ...
                  var id = $('#id').val();
                  if(save_method == "add") url = "{{ route('superadmindasarnotadinas.store') }}";
        ...
        $(function() {
          $('#modaldasarnotabaru form').validator().on('submit', function(e) {
              if(!e.isDefaultPrevented()) {
                  ...
                  var id = $('#id').val();
                  if(save_method == "add") url = "{{ route('superadmindasarnotadinas.storebaru') }}";
                  else url = "dasarnota/"+id;
...
$(function() {
    $('.select-dasar').select2({
        ...
        minimumInputLength : 4,
        ajax: {
          url: '{{ url('superadmin/notadinas/apidasar/') }}',
          dataType: 'json',
          delay: 250,
          processResults: function (data) {
            return {
