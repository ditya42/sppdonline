        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="body">
                                <form action="{{ route('manajemenuser.store') }}" id="form-input" class="form-horizontal" method="post" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label for="" class="control-label">Pilih Pegawai</label>
                                            <select class="form-control select-pejabatpenilai" name="pegawai_id" id="targettahunan_pejabat1">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
