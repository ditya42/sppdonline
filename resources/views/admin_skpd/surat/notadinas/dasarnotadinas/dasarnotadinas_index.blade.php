                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <ul class="breadcrumb justify-content-end">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('adminskpdnotadinas.notadinas.index') }}">Nota Dinas Perjalanan</a></li>
            ...
            <div class="row clearfix">
                <div class="col-12">
                        <div class="card">
                            ...
                            <a style="margin-left: 10px;" href="{{ route('adminskpdnotadinas.notadinas.index') }}"><button type="button" class="btn btn-success"><i class="fa fa-backward"></i> Kembali</button></a>
    ...
    <script>
        ...
        $(function() {
          ...
          table = $('.table').DataTable({
              ...
              serverSide: true,
              "ajax": {
                    "url": "{!! route('dasarnotadinasadminskpd.data') !!}",
                    "data": {
                    "id": idnota
                    },
              },
