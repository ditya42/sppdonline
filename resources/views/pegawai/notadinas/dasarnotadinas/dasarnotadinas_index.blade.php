        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-12">
                        <div class="card">
                            <br>
                            <a style="margin-left: 20px;"  data-toggle="modal" onclick="addform()"><button type="button" class="btn btn-primary"><i class="fa fa-hand-pointer-o"></i> Pilih Dasar Surat</button></a>
                            <a style="margin-left: 10px;" href="{{ route('pegawai.notadinas.index') }}"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Dasar Surat Baru</button></a>
